...
<style lang="scss" global>
  ...
  // }
/* ----------------------------------------------
* Generated by Animista on 2023-1-13 23:8:3
* Licensed under FreeBSD License.
* See http://animista.net/license for more info. 
* w: http://animista.net, t: @cssanimista
* ---------------------------------------------- */
@keyframes anim-in{0%{transform:translateX(1000px);opacity:0}100%{transform:translateX(0);opacity:1}}
@keyframes anim-out{0%{transform:translateX(0);opacity:1}100%{transform:translateX(-1000px);opacity:0}}
</style>