<script lang="ts">
  ...
  const sections = [
    ...
    [
      { img: "img68.jpg", tds: "Boscoseal AC _new_.pdf", useApplication: true, },
      { img: "img64.jpg", tds: "Boscolastic _new_REV02.pdf", useApplication: true, },
      { img: "img66.jpg", tds: "Boscoseal Slurry _new_REV02.pdf", useApplication: true, },
      { img: "img73.jpg", tds: "Boscoseal Torch On.pdf", useApplication: true, },
      { img: "img77.png", tds: "TDS BOSTIK FLASHBAND.pdf", useApplication: true, },
    ],
    [
      { img: "img82.jpg", tds: "seal_n_flex___1_0815.pdf", useApplication: true, },
      { img: "img86.jpg", tds: "TDS BOSTIK SEAL N FLEX 1.pdf", useApplication: true, count: 3, },
      { img: "img88.jpg", tds: "TDS BOSTIK SMARTFLEX.pdf", useApplication: true, },
...
<Article title={ $t(tp + 'page.title') }>
  ...
  <br />
  <p>
    <a href="/pdfs/Bostik Catalogue 2021-LR.pdf" download target="_blank" rel="noopener noreferrer external">
