...
<style lang="scss" global>
  ...
  // @keyframes anim-in{0%{opacity:0}100%{opacity:1}}
  // @keyframes anim-out{0%{opacity:1}100%{opacity:0}}
  @keyframes anim-in{0%{transform:translateX(100%)}100%{transform:translateX(0)}}
  @keyframes anim-out{0%{transform:translateX(0)}100%{transform:translateX(-100%)}}
</style>